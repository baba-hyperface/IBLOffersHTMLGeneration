function getTemplate6(data, TemplateHelpers, lightColor) {
  return `
  <html>
<head>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#fff" style="background:#fff;max-width:600px;margin:0 auto;">
    <tr>
      <td align="right" valign="middle" style="font-family: Arial; font-size: 14px; line-height: 18px; padding:0px; background-color: ${
        ...
        ${TemplateHelpers.getNavbarSingleLogo(data,data.backgroundColor)}
       </td>
    </tr>
    <tr>
      <td align="center" bgcolor="#fff" style="padding:40px 0 0 0;background-color: ${
        data.backgroundColor
      }">
        <div class="headline">${
...
return getTemplate6(data, TemplateHelpers, lightColor);
