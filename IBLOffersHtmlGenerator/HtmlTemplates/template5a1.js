...
<body>
  ...
  <table class="table" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="${
                                        ...
                                        <tr>
                                           <td style="background-color:${
                                             data.backgroundColor
                                                ...
                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:100%;" bgcolor="${
                                                  data.backgroundColor
                                                }">
                                                    <tr>
                                                        <td align="left" valign="middle" style="padding: 8px; background-color:${
                                                          data.backgroundColor
                                                        };">
...
function getTemplate5preview(data, TemplateHelpers, lightColor) {
  return `
    <!DOCTYPE html>
<html lang="en">
<head>
