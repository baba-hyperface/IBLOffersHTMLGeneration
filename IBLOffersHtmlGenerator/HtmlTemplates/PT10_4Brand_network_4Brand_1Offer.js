...
<table class="table" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" >
  ...
  <tbody>
    <tr>
		<td align="left" valign="top" style="padding: 0 0 0 0;"><img src="${
      data.networklogo
    }" alt="IndusInd Bank" style="display: block; width: auto; min-height: 28px; max-height: 28px; height: 28px;" class="logo"/></td> 
